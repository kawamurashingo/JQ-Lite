...
![CPAN Favorites](https://img.shields.io/badge/dynamic/json?color=orange&label=CPAN%20favorites&query=$.favorite_count&url=https://fastapi.metacpan.org/v1/favorite/_search?q=distribution:JQ-Lite)
