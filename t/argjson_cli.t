...
is($bad_exit, 5, 'invalid --argjson input exits with usage error code');
like($bad_stderr, qr/^\[USAGE\] invalid JSON for --argjson cfg:/i, 'error message is surfaced for invalid JSON');
